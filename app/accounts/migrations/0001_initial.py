...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='PensionSystemInformation',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('female_pension_age', models.FloatField()),
                ('male_life_expectancy', models.FloatField()),
                ('female_life_expectancy', models.FloatField()),
                ('country', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='pension_system_information', to='countries.country')),
